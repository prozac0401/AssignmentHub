...
현재 [v1.3.0 릴리즈](https://github.com/prozac0401/AssignmentHub/releases/tag/v1.3.0)의 매뉴얼·퀵가이드 첨부 파일을 사용하세요. 상세 기능 검증 범위는 [검증 보고서](docs/test-report.md)와 [Python 내장 배포 검증 결과](docs/portable-test-report.md)를 참고하세요.
...
1. [**`AssignmentHub-1.3.0-windows-x64.zip`**](https://github.com/prozac0401/AssignmentHub/releases/download/v1.3.0/AssignmentHub-1.3.0-windows-x64.zip) 전체를 쓰기 가능한 폴더에 압축 해제합니다. Windows 10/11 x64용이며 Python·Tcl/Tk·라이브러리·Caddy가 모두 포함되어 있습니다.
